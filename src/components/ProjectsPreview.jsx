    ...
    <section id="projects" className="py-16 bg-darkblue">
      <div className="max-w-7xl mx-auto px-7 md:px-20">
        <div className="flex items-end justify-between gap-6 mb-10">
          <div>
            <h2 className="text-neutral-100 font-headings text-3xl md:text-4xl font-bold">Utførte prosjekter</h2>
        ...
        <div className="grid gap-7 md:grid-cols-2 lg:grid-cols-3">
          {projects.map((project) => (
            <Link key={project.id} to={`/prosjekter/${project.slug}`} className="group bg-white rounded-sm shadow-lg overflow-hidden hover:shadow-xl transition flex flex-col h-full">
