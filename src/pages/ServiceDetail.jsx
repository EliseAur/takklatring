  ...
  return (
    <main>
      ...
      <section className="bg-darkblue">
        <div className="max-w-4xl mx-auto px-6 md:px-0 py-12 lg:py-16 grid gap-5 lg:grid-cols-2 lg:items-center">
          {/* Text */}
          <div className="max-w-4xl mx-auto md:px-14 lg:px-4 sm:py-6 lg:pt-0">
            ...
            {service?.acf?.tjeneste_short_description && <p className="mt-4 text-lg text-neutral-300">{service.acf.tjeneste_short_description}</p>}

            <a href="#content" className="mt-4 inline-block text-white font-bold hover:pointer-cursor">
              Les mer →
            </a>
          ...
          {/* Image */}
          {service.image_url && (
            <div className="overflow-hidden rounded-md shadow-md md:px-14 lg:px-4">
              <img src={service.image_url} alt={service.image_alt || ""} className="w-full aspect-[4/3] sm:aspect-[3/4] object-cover object-center max-h-[500px]" />
            </div>
          )}
        </div>
      </section>
      ...
      <section id="content" className="scroll-mt-[125px] lg:scroll-mt-[100px] w-full bg-neutral-100">
        <div className="max-w-6xl mx-auto px-6 pt-0 lg:pt-6 pb-6">
